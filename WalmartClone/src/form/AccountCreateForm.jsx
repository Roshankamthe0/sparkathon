...
const AccountCreateForm = () => {
  ...
  function formSubmit() {
    console.log(n);
    setName(n, password); // store in context
  ...
  return (
    <Box display="flex" flexDirection="column" alignItems="center" mt={15}>
      <Box display="flex" flexDirection="column" alignItems="center">
        ...
        <Text textAlign="center" fontSize={20}>Create your Walmart account</Text>
        <Text textAlign="center" mt={5}>Email Address <u>{email}</u></Text>
        <br />
        <FormControl>
          ...
          <ChakraLink as={ReactRouterLink} to="/account/otp" _hover={{ textDecoration: "none" }}>
            <Input
              w={400}
              type="submit"
          ...
          <br /><br />
          <Checkbox defaultChecked colorScheme="blue">Keep me signed in</Checkbox>
        </FormControl>
        <br />
        <Text>
